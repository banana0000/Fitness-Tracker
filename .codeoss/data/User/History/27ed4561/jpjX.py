    ...
    [
        ...
        dbc.Card(
            dbc.CardBody(
                [
                    html.P(
                        "Enter your daily steps. Calories are calculated automatically.",
                        className="text-light",
                    ),
                    dbc.Row(
                        [
                            dbc.Col(
                                dbc.Input(id="input-day", placeholder="Day (e.g. Monday)",
                                          type="text"), md=6),
                            dbc.Col(
                                dbc.Input(id="input-steps", placeholder="Steps",
                                          type="number"), md=6),
                        ],
                        className="mb-3",
                    ),
